...
export class SwitchCase {
     ...
     * @type {Word} - word representation of type, TODO: change to list in order to allow  multi enum switch
     */
    get memberName() {
     ...
     * @param {Scope} scope
     * @param {DataType} enumType - TODO: change this to list, in order to allow a multi-enum switch
     * @returns {Typed}
     */
