declare module "helios" {
     ...
     * @returns {Tout}
     */
    export function assertClass<Tin, Tout>(
        obj: Tin,
        C: new (...any: any[]) => Tout,
        msg?: string
    ): Tout
     ...
     * @returns {null | [Ta, Tb][]}
     */
    export function reduceNullPairs<Ta, Tb>(
        pairs: [Ta | null, Tb | null][]
    ): [Ta, Tb][] | null
    /**
     ...
     * @returns {string}
     */
    export function byteToBitString(
        b: number,
        n?: number,
        prefix?: boolean
    ): string
     ...
     */
    export function HList<T extends HeliosData>(
        ItemClass: HeliosDataClass<T>
    ): HeliosDataClass<{
        /**
         * @type {T[]}
         */
     ...
     */
    export function HMap<TKey extends HeliosData, TValue extends HeliosData>(
        KeyClass: HeliosDataClass<TKey>,
        ValueClass: HeliosDataClass<TValue>
    ): HeliosDataClass<{
        /**
         * @type {[TKey, TValue][]}
         */
     ...
     */
    export function Option<T extends HeliosData>(
        SomeClass: HeliosDataClass<T>
    ): HeliosDataClass<{
        /**
         * @type {?T}
         */
     ...
     * @returns {UplcProgram}
     */
    export function deserializeUplc(
        json:
            | string
            | {
                  cborHex: string
     ...
     * @returns {TypeMembers}
     */
    export function genCommonEnumTypeMembers(
        type: Type,
        parentType: Type
    ): TypeMembers
    /**
     ...
     */
    export function setRawUsageNotifier(
        callback: (name: string, count: number) => void
    ): void
    /**
    ...
    export function fetchRawGenerics(
        ctx: ToIRContext
    ): Map<string, (ttp: string[], ftp: string[]) => IR>
    /**
     ...
     */
    export function fetchRawFunctions(
        ctx: ToIRContext,
        ir: IR,
        userDefs?: null | IRDefinitions
    ): IRDefinitions
    /**
     * @internal
     * @param {ToIRContext} ctx
     ...
     */
    export function setImportPathTranslator(
        fn: (path: StringLiteral) => string | null
    ): void
    /**
     * @internal
     * @param {Token[]} ts
     ...
     * @internal
     */
    export function buildScriptPurpose(
        ts: Token[],
        expectedPurpose?: null | ScriptPurpose
    ): [ScriptPurpose, Word] | null
    /**
     * Also used by VSCode plugin
     * @internal
     * @param {Token[]} ts
    ...
    export function buildScript(
        ts: Token[],
        expectedPurpose?: null | ScriptPurpose
    ): [null | ScriptPurpose, Word | null, Statement[], number]
    /**
     ...
     */
    export function extractScriptPurposeAndName(
        rawSrc: string
     ...
     * @internal
     */
    export function buildIRExpr(
        ts: Token[],
        funcTagger?: IRExprTagger | null
    ): IRExpr
    /**
     ...
     */
    export function jsToUplcInternal(
        schema: TypeSchema,
        obj: any,
        helpers: JsToUplcHelpers
    ): Promise<UplcData>
    /**
     * @internal
     * @param {TypeSchema} schema
     ...
     * @returns {Promise<any>}
     */
    export function uplcToJs(
        schema: TypeSchema,
        data: UplcData,
        helpers: UplcToJsHelpers
    ): Promise<any>
    /**
    ...
    export class IR {
         ...
         */
        static new(
            content: string | TemplateStringsArray | IR[],
            ...args: (Site | string | IR | IR[] | null | number)[]
        ): IR
        /**
    ...
    export class MintingPolicyHash extends ScriptHash {
         ...
         */
        static fromProps(
            props: MintingPolicyHash | MintingPolicyHashProps
        ): MintingPolicyHash
        /**
         * @param {number[]} bytes
         * @returns {MintingPolicyHash}
    ...
    export class TxOutputId extends HeliosData {
         ...
         */
        static cleanConstructorArgs(
            props: TxOutputIdProps
        ): [TxId | TxIdProps, HInt | HIntProps]
        /**
         * @returns {TxOutputId}
         */
    ...
    export class UplcBuiltinConfig {
        ...
        constructor(
            ...
            nArgs: number,
            allowAny: boolean,
            memCostModelClass: CostModelClass,
            cpuCostModelClass: CostModelClass
        )
        get name(): string
    ...
    export class UplcRte {
         ...
         */
        constructor(
            callbacks?: UplcRTECallbacksInternal,
    ...
    export class CallFrame extends UplcFrame {
        ...
        constructor(
            term: UplcCall,
            fn: UplcLambdaWithEnv | AppliedUplcBuiltin,
            env: CekEnv
        )
        /**
         * @readonly
    ...
    export class UplcProgram {
        ...
        run(
            ...
            networkParams?: null | NetworkParams
        ): Promise<UplcValue | RuntimeError>
        /**
        ...
        runWithPrint(
            args: null | UplcValue[]
        ): Promise<[UplcValue | RuntimeError, string[]]>
        /**
    ...
    export class Tokenizer {
         ...
         * @returns {string[]}
         */
        static assertCorrectDecimalUnderscores(
            site: Site,
            chars: string[],
            reverse?: boolean
        ): string[]
     ...
     * @implements {DataType}
     */
    export class GenericType<T extends HeliosData>
        extends Common
        implements DataType
    {
        /**
     ...
     */
    export class GenericEnumMemberType<T extends HeliosData>
        extends GenericType<T>
        implements EnumMemberType
    {
        /**
     ...
     * @implements {DataType}
     */
    export class GenericParametricType<T extends HeliosData>
        extends GenericType<any>
        implements DataType {}
    /**
     * Created by statements
     * @internal
     ...
     */
    export class GenericParametricEnumMemberType<T extends HeliosData>
        extends GenericEnumMemberType<T>
        implements EnumMemberType {}
    /**
     * @internal
    ...
    export class ParametricFunc extends Common implements Parametric {
         ...
         */
        get offChainType():
            | ((...any: any[]) => HeliosDataClass<HeliosData>)
            | null
    ...
    export class BuiltinFunc extends Common implements Func, Named {
         ...
         * }} props
         */
        constructor({ name, type }: { name: string; type: FuncType })
        /**
         * @type {string}
         */
        get name(): string
     ...
     * @implements {DataType}
     */
    export class TupleType<T extends HeliosData>
        extends GenericType<any>
        implements DataType
    {
        /**
     ...
     * @implements {TypeClass}
     */
    export class ValuableTypeClass
        extends DefaultTypeClass
        implements TypeClass {}
    /**
     * Buitin Address type
     * @internal
    ...
    export class FuncArg extends NameTypePair {
         ...
         * @returns {IR}
         */
        static wrapWithDefaultInternal(
            bodyIR: IR,
            name: string,
            defaultIR: IR
        ): IR
    ...
    export class UnconstrDataSwitchCase extends SwitchCase {
        ...
        constructor(
            site: Site,
            intVarName: Word | null,
            lstVarName: Word | null,
            bodyExpr: Expr
        )
        /**
         * @param {Scope} scope
    ...
    export class Statement extends Token {
        ...
        loopConstStatements(
            namespace: string,
            callback: (name: string, cs: ConstStatement) => void
        ): void
        /**
    ...
    export class TypeParameters {
         ...
         */
        evalParametricFuncType(
            scope: Scope,
            evalConcrete: (scope: Scope) => null | FuncType,
            impl?: null
        ): null | ParametricFunc | FuncType
        /**
         * @param {Scope} scope
         * @param {(scope: Scope) => (null | FuncType)} evalConcrete
         * @returns {null | EvalEntity}
        ...
        createParametricType(
            scope: Scope,
            site: Site,
            evalConcrete: (scope: Scope) => DataType
        ): [DataType | ParametricType, Scope]
        #private
    }
    /**
    ...
    export class ImplDefinition {
        ...
        constructor(
            selfTypeExpr: Expr,
            statements: (FuncStatement | ConstStatement)[]
        )
        /**
         * @type {Site}
         */
    ...
    export class IRNameExpr implements IRExpr {
         ...
         */
        copy(
            notifyCopy: (oldExpr: IRExpr, newExpr: IRExpr) => void,
            varMap: Map<IRVariable, IRVariable>
        ): IRNameExpr
        /**
         * @internal
         * @returns {boolean}
    ...
    export class IRProgram {
         ...
         */
        static assertValidRoot(
            expr: IRExpr
        ): IRFuncExpr | IRCallExpr | IRLiteralExpr
        /**
         * @internal
         * @param {IR} ir
         ...
         */
        constructor(
            expr: IRFuncExpr | IRCallExpr | IRLiteralExpr,
            properties: ProgramProperties
        )
        /**
         * @returns {string}
    ...
    export class Program {
         ...
         */
        static parseMainInternal(
            rawSrc: string
        ): [ScriptPurpose | null, Module[]]
        /**
         * @internal
         ...
         * @returns {TopScope}
         */
        evalTypes(validatorTypes?: { [name: string]: Type }): TopScope
        /**
         * @type {UserTypes}
         */
        get types(): UserTypes
         ...
         */
        set parameters(arg: { [name: string]: any })
        /**
        ...
        statementsToIR(
            ctx: ToIRContext,
            endCond: (s: Statement, isImport: boolean) => boolean
        ): IRDefinitions
        /**
         * @internal
         * @param {IR} ir
    ...
    export class Tx extends CborData {
        ...
        mintTokens(
            mph: MintingPolicyHash | MintingPolicyHashProps,
            tokens: [ByteArray | ByteArrayProps, HInt | HIntProps][],
            redeemer: UplcDataValue | UplcData | null
        ): Tx
        /**
        ...
        addInputs(
            inputs: TxInput[],
            redeemer?: (UplcDataValue | UplcData | HeliosData) | null
        ): Tx
        /**
    ...
    export class TxOutput extends CborData {
        ...
        correctLovelace(
            networkParams: NetworkParams,
            updater?: ((output: TxOutput) => void) | null
        ): void
        #private
    }
    /**
    ...
    export class DCertDelegate extends DCert {
         ...
         */
        constructor(
            stakeHash: PubKeyHash | StakingValidatorHash,
            poolHash: PubKeyHash
        )
        /**
         * Get stake pool hash.
    ...
    export class StakeAddress {
         ...
         * @returns {StakeAddress}
         */
        static fromStakingValidatorHash(
            isTestnet: boolean,
    ...
    export type JsToUplcConverter = (
        obj: any,
        helpers: JsToUplcHelpers
    ) => Promise<UplcData>
    export type UplcToJsConverter = (
        data: UplcData,
        helpers: UplcToJsHelpers
    ) => Promise<any>
    export type DataType = Named &
        Type & {
            asDataType: DataType
            fieldNames: string[]
            offChainType: null | HeliosDataClass<HeliosData>
    ...
    export type AssetsProps =
        | [AssetClass | AssetClassProps, HInt | HIntProps][]
        | [
              MintingPolicyHash | MintingPolicyHashProps,
              [ByteArray | ByteArrayProps, HInt | HIntProps][]
          ][]
    ...
    class UplcStack {
         ...
         */
        constructor(
            parent: null | UplcStack | UplcRte,
            value?: null | UplcValue,
    ...
    class RawFunc {
        ...
        constructor(
            name: string,
            definition: string | ((ttp: string[], ftp: string[]) => string)
        )
        /**
         * @type {string}
         */
    ...
    class SwitchExpr extends Expr {
        ...
        constructor(
            ...
            controlExpr: Expr,
            cases: SwitchCase[],
            defaultCase?: null | SwitchDefault
        )
