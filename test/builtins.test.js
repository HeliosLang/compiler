...
async function testBuiltins() {
    ...
    func main() -> Int {
        ...
        ([_], res) => asInt(res) == BigInt(0x287fb4cd),
        1
    )
    ...
    func main(a: Real) -> Int {
        ...
        ([a], res) => {
            return (
                Number(asInt(res)) === Math.trunc(Number(asInt(a) / REAL_ONE))
            )
        }
    )
    ...
    func main(x: Real) -> Real {
        ...
        ([a_], res) => {
            ...
            if (a < 0n) {
                ...
                return (
                    Math.abs(
                        Math.sqrt(Number(a) / 1000000) -
                            Number(asInt(res)) / 1000000
                    ) < 1e-5
                )
            }
        }
    ...
    if (testByteArray) {
        ...
        func main(a: ByteArray, b: ByteArray) -> ByteArray {
            ...
            ([a, b], res) =>
                equalsList(asBytes(a).concat(asBytes(b)), asBytes(res))
        )

        await ft.test(
            [ft.bytes(0, 5), ft.bytes(0, 5)],
            `
        ...
        func main(a: ByteArray, b: Int) -> ByteArray {
            ...
            ([a, b], res) => {
                ...
                let start =
                    asInt(b) < 0n ? n + 1 + Number(asInt(b)) : Number(asInt(b))
                if (start < 0) {
                    start = 0
                } else if (start > n) {
                    start = n
        ...
        await ft.test(
            [ft.bytes(0, 64), ft.int(-10, 100), ft.int(-10, 100)],
            `
        ...
        func main(a: ByteArray, b: Int, c: Int) -> ByteArray {
            ...
            ([a, b, c], res) => {
                ...
                let end =
                    asInt(c) < 0n ? n + 1 + Number(asInt(c)) : Number(asInt(c))
                if (end < 0) {
                    end = 0
                } else if (end > n) {
                    end = n
        ...
        func main(a: ByteArray) -> String {
            ...
            ([a], res) => {
                let s = Array.from(asBytes(a), (byte) =>
    ...
    if (testList) {
        ...
        func main(a: []Int) -> Int {
            ...
            ([a], res, isSimplified) => {
                ...
                if (lst.length == 1) {
                    ...
                    return isError(
                        res,
                        isSimplified ? "" : "not a singleton list"
                    )
                }
            }
        )
            ...
            ([a], res, isSimplified) => {
                ...
                if (lst.filter((i) => i == 0n).length == 1) {
                    ...
                    return (
                        isError(
                            res,
                            isSimplified ? "" : "not a singleton iterator"
                        ) || isError(res, "empty iterator, not a singleton")
                    )
                }
            }
        )
        ...
        await ft.test(
            [ft.list(ft.int()), ft.int(-10, 32), ft.int()],
            `
        testing list_set
        func main(a: []Int, b: Int, c: Int) -> []Int {
            a.set(b, c)
        ...
        func main(a: []Int, n: Int) -> []Int {
            ...
            ([lst_, n_], res) => {
                ...
                if (n > lst.length) {
                    ...
                    return (
                        n + resLst.length == lst.length &&
                        equalsList(resLst, lst.slice(n))
                    )
                }
            }
        )
        ...
        func main(a: []Int, n: Int) -> []Int {
            ...
            ([lst_, n_], res) => {
                ...
                if (n > lst.length) {
                    ...
                    return (
                        n == resLst.length &&
                        equalsList(resLst, lst.slice(0, n))
                    )
                }
            }
        )
        ...
        func main(a: []Int, n: Int) -> []Int {
            ...
            ([lst_, n_], res) => {
                ...
                if (n > lst.length) {
                    ...
                    return (
                        n + resLst.length == lst.length &&
                        equalsList(resLst, lst.slice(0, lst.length - n))
                    )
                }
            }
        )
        ...
        func main(a: []Int) -> Option[Int] {
            ...
            ([a], res) => {
                ...
                if (la.every((i) => i <= 0n)) {
                    ...
                    return (
                        asData(res).index == 0 &&
                        asInt(asData(res).fields[0]) == la.find((i) => i > 0n)
                    )
                }
            }
        )
        ...
        func main(a: []Int) -> []Int {
            ...
            ([a], res) => {
                ...
                return (
                    la.length == lRes.length && la.every((a, i) => a == lRes[i])
                )
            }
        )
        ...
        func main(a: Data) -> []Int {
            ...
            ([a], res) => {
                ...
                return (
                    la.length == lRes.length && la.every((v, i) => v == lRes[i])
                )
            }
        )
        ...
        await ft.test(
            [ft.list(ft.list(ft.int(), 0, 4), 0, 4)],
            `
    ...
    if (testMap) {
        ...
        func main(a: Map[Int]Int, b: Map[Int]Int) -> Map[Int]Int {
            ...
            ([a, b], res) =>
                asData(res).isSame(new MapData(a.data.map.concat(b.data.map)))
        )

        await ft.test(
            [ft.map(ft.int(), ft.int(), 0, 10), ft.int(), ft.int()],
            `
        testing map_prepend
        ...
        func main(a: Map[Int]Int) -> Map[Int]Int {
            ...
            ([a], res) => {
                if (a.data.map.length == 0) {
                    ...
                    return (
                        la.length == lRes.length &&
                        la.every(
                            ([k, v], i) =>
                                asInt(k) === asInt(lRes[i][0]) &&
                                asInt(v) === asInt(lRes[i][1])
                        )
                    )
                }
            }
        ...
        func main(a: Map[Int]Int) -> Bool {
            ...
            ([a], res) =>
                a.data.map.every(([k, v]) => asInt(k) < asInt(v)) ===
                asBool(res)
        )
        ...
        func main(a: Map[Int]Int) -> Bool {
            ...
            ([a], res) =>
                a.data.map.every(([k, _]) => asInt(k) > 0n) === asBool(res)
        )
        ...
        func main(a: Map[Int]Int) -> Bool {
            ...
            ([a], res) =>
                a.data.map.every(([_, v]) => asInt(v) > 0n) === asBool(res)
        )
        ...
        func main(a: Map[Int]Int) -> Bool {
            ...
            ([a], res) =>
                a.data.map.some(([k, v]) => asInt(k) < asInt(v)) === asBool(res)
        )
        ...
        func main(a: Map[Int]Int) -> Bool {
            ...
            ([a], res) =>
                a.data.map.some(([k, _]) => asInt(k) > 0n) === asBool(res)
        )
        ...
        func main(a: Map[Int]Int) -> Bool {
            ...
            ([a], res) =>
                a.data.map.some(([_, v]) => asInt(v) > 0n) === asBool(res)
        )
        ...
        func main(a: Map[Int]Int) -> Bool {
            ...
            ([a], res, isSimplified) => {
                ...
                if (failed) {
                    return isError(
                        res,
                        isSimplified ? "" : "neg key or value found"
                    )
                } else {
                    return asBool(res)
                }
        ...
        func main(a: Map[Int]Int) -> Map[Int]Int {
            ...
            ([a], res) => {
                if (a.data.map.some(([k, _]) => asInt(k) == 0n)) {
                    return (
                        asData(res).map.length == 1 &&
                        asInt(asData(res).map[0][0]) === 0n
                    )
                } else {
                    return isError(res, "not found")
                }
        ...
        await ft.test(
            [ft.map(ft.int(0, 3), ft.int()), ft.int(0, 3)],
            `
        testing map_delete
        ...
        await ft.test(
            [ft.map(ft.int(), ft.int()), ft.int(), ft.int()],
            `
        testing map_set
        func main(m: Map[Int]Int, key: Int, value: Int) -> Map[Int]Int {
            ...
            ([_, key, value], res) => {
                return asData(res).map.some((pair) => {
                    return (
                        asInt(pair[0]) === asInt(key) &&
                        asInt(pair[1]) === asInt(value)
                    )
                })
            }
        )
        ...
        await ft.test(
            [ft.map(ft.int(0, 10), ft.int()), ft.int(0, 10), ft.int()],
            `
        testing map_update
        func main(m: Map[Int]Int, key: Int, value: Int) -> Map[Int]Int {
            ...
            ([m, key, value], res) => {
                ...
                return asData(m).map.every((pair, i) => {
                    ...
                    if (asInt(pair[0]) == asInt(key)) {
                        return (
                            asInt(resMap[i][1]) == asInt(pair[1]) + asInt(value)
                        )
                    } else {
            ...
            ([_], res) => {
                return asData(res).map.every(([k, v], i) => {
                    if (i > 0) {
                        ...
                        return (
                            asInt(kPrev) + asInt(vPrev) <= asInt(k) + asInt(v)
                        )
                    } else {
                        return true
                    }
    ...
    await ft.test(
        [ft.option(ft.int(0, 5)), ft.option(ft.int(0, 5))],
        `
    testing option_eq_2
    ...
    func main(a: Option[Int]) -> Option[Bool] {
        ...
        ([a], res) => {
            if (res instanceof RuntimeError) {
                ...
                return (
                    asBool(res.data.fields[0]) == asInt(a.data.fields[0]) > 0n
                )
            }
        }
    )
        ...
        ([a], res) => {
            return (
                [
                    ...
                    [0x7e],
                    [0x7f]
                ].some((ba) => equalsList(asBytes(a), ba)) === asBool(res)
            )
        }
    )
    ...
    func main(a: ByteArray, b: ByteArray) -> Bool {
        ...
        ([a, b], res) =>
            (asBytes(a).length == 0 && asBytes(b).length == 0) === asBool(res)
    )
    ...
    func main(a: ByteArray, b: ByteArray) -> String {
        ...
        ([a, b], res) => {
            return (
                asString(res) ==
                `${bytesToHex(asBytes(a))}.${bytesToHex(asBytes(b))}`
            )
        }
    )
    ...
    func main(a: ByteArray, b: ByteArray) -> ByteArray {
        ...
        ([a, b], res) => {
            let ref = new ConstrData(0, [
                new ByteArrayData(asBytes(a)),
                new ByteArrayData(asBytes(b))
            ])
    ...
    if (testValue) {
        ...
        func main(a: Int) -> Value {
            ...
            ([a], res) => {
                if (res instanceof RuntimeError) {
                    ...
                    return (
                        res.data.map.length == 1 &&
                        res.data.map[0][1].map[0][1].int == asInt(a)
                    )
                }
            }
        )
        ...
        await ft.test(
            [ft.map(ft.bytes(), ft.map(ft.bytes(), ft.int()))],
            `
    ...
    if (testScriptContext) {
        ...
        ${spendingScriptContextParam(false)}
        `,
            ([ctx], res) => ctx.data.fields[0].isSame(asData(res)),
            10
        )
        ...
        ${spendingScriptContextParam(false)}
        `,
            ([ctx], res) => ctx.data.fields[1].fields[0].isSame(asData(res)),
            10
        )

        await ft.testParams(
            { TX_ID_IN_BYTES: ft.bytes() },
            ["FIRST_TX_INPUT", "SCRIPT_CONTEXT"],
            `
        ...
        await ft.testParams(
            { CURRENT_VALIDATOR_BYTES: ft.bytes(), QTY_2: ft.int() },
            ["QTY_2", "SCRIPT_CONTEXT"],
            `
        ...
        await ft.testParams(
            { CURRENT_VALIDATOR_BYTES: ft.bytes() },
            ["CURRENT_VALIDATOR", "SCRIPT_CONTEXT"],
            `
        ...
        await ft.testParams(
            { CURRENT_MPH_BYTES: ft.bytes() },
            ["CURRENT_MPH", "SCRIPT_CONTEXT"],
            `
        ...
        await ft.testParams(
            { CURRENT_STAKING_CRED_BYTES: ft.bytes() },
            ["CURRENT_STAKING_CRED", "SCRIPT_CONTEXT"],
            `
        ...
        ${spendingScriptContextParam(false)}
        `,
            ([ctx], res) => asData(res).isSame(ctx.data),
            10
        )
    ...
    if (testStakingPurpose) {
        ...
        ${rewardingScriptContextParam}
        `,
            ([sp], res) => sp.data.isSame(asData(res)),
            5
        )
    ...
    if (testTx) {
        ...
        await ft.testParams(
            { QTY: ft.int(200000, 3000000) },
            ["CURRENT_TX_ID", "SCRIPT_CONTEXT"],
            `
        testing tx_id
        ...
        ${spendingScriptContextParam(false)}
        `,
            ([tx], res) => asData(res).isSame(tx.data),
            5
        )
    ...
    ${spendingScriptContextParam(false)}
    `,
        ([txId], res) => asData(res).isSame(txId.data),
        2
    )
    ...
    `,
        ([ctx], res) => {
            return decodeCbor(asBytes(res)).isSame(
                ctx.data.fields[0].fields[0].list[0]
            )
        },
        5
    )
    ...
    `,
        ([ctx], res) => {
            return decodeCbor(asBytes(res)).isSame(
                ctx.data.fields[0].fields[2].list[0]
            )
        },
        5
    )
    ...
    if (testOutputDatum) {
        ...
        await ft.testParams(
            {
                CONSTR_INDEX: ft.int(0, 3),
                INLINE_DATA: ft.int(),
                DATUM_HASH_BYTES: ft.bytes()
            },
            ["DATUM_HASH", "INLINE_DATA", "OUTPUT_DATUM"],
            `
        testing outputdatum_eq
    ...
    await ft.test(
        [ft.bytes(0, 3), ft.int(0, 2), ft.bytes(0, 3), ft.int(0, 2)],
        `
    ...
    `,
        ([ctx], res) => {
            return decodeCbor(asBytes(res)).isSame(
                ctx.data.fields[0].fields[0].list[0].fields[0]
            )
        },
        5
    )
    ...
    await ft.test(
        [ft.int(0, 5), ft.bytes(28, 28), ft.bytes(28, 28)],
        `
    ...
    await ft.testParams(
        { PUB_KEY_HASH_BYTES: ft.bytes() },
        ["STAKING_CRED_IN", "SCRIPT_CONTEXT"],
        `
    ...
    `,
        ([ctx], res) => {
            return decodeCbor(asBytes(res)).isSame(
                ctx.data.fields[0].fields[0].list[0].fields[1].fields[0]
            )
        },
        5
    )
    ...
    await ft.testParams(
        { HAS_STAKING_CRED_IN: ft.bool(), STAKING_CRED_TYPE: ft.bool() },
        ["SCRIPT_CONTEXT"],
        `
    testing staking_credential_eq
    func main(ctx: ScriptContext) -> Bool {
    ...
    func main(a: Int) -> Duration {
        ...
        ([a], res) => asInt(a) * 1000n * 60n == asInt(res),
        5
    )
    ...
    func main(a: Int) -> Duration {
        ...
        ([a], res) => asInt(a) * 1000n * 60n * 60n == asInt(res),
        5
    )
    ...
    func main(a: Int) -> Duration {
        ...
        ([a], res) => asInt(a) * 1000n * 60n * 60n * 24n == asInt(res),
        5
    )
    ...
    func main(a: Int) -> Duration {
        ...
        ([a], res) => asInt(a) * 1000n * 60n * 60n * 24n * 7n == asInt(res),
        5
    )
    ...
    func main(a: Int, b: Int, c: Int, d: Int) -> Bool {
        ...
        ([a, b, c, d], res) =>
            (asInt(a) == asInt(c) && asInt(b) == asInt(d)) === asBool(res)
    )
    ...
    func main(a: Int, b: Int) -> String {
        ...
        ([a, b], res) => {
            return (
                asString(res) ==
                `[${asInt(a).toString()},${asInt(b).toString()}]`
            )
        },
        5
    )
    ...
    func main(a: Int) -> String {
        ...
        ([a], res) => asString(res) == `[${asInt(a).toString()},+inf]`,
        5
    )
    ...
    func main(a: Int) -> String {
        ...
        ([a], res) => asString(res) == `[-inf,${asInt(a).toString()}]`,
        5
    )
